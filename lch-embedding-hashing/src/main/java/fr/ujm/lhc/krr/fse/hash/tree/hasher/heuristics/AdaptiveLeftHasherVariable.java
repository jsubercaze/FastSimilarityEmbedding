 ...
 * 
 */
public class AdaptiveLeftHasherVariable implements TreeHasher {
	...
	private final static Logger LOGGER = Logger
			.getLogger(AdaptiveLeftHasherVariable.class);
	 ...
	 * @param sortChildren
	 */
	public AdaptiveLeftHasherVariable(final boolean onemorebit,
